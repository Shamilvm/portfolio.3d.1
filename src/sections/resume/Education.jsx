export function Education({ data }) {
  ...
  return (
    <div id="education" className="py-10">
      <h2 className="font-medium text-primary text-base">education.</h2>

      <ul className="flex flex-col gap-8 mt-4 font-normal text-primary text-base">
        {data.map((item, index) => (
          <li
            key={index}
          ...
          >
            <div className="flex sm:flex-row flex-col justify-between items-start">
              <div>
                ...
                <p className="text-sm text-primary/80 mt-1">{item.SCHOOL}</p>
                {item.MARK && (
